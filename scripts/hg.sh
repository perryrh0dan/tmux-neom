...
IFS=' ' read -r -a hide_status <<< $(get_tmux_option "@neom-hg-disable-status" "false")
IFS=' ' read -r -a current_symbol <<< $(get_tmux_option "@neom-hg-show-current-symbol" "✓")
IFS=' ' read -r -a diff_symbol <<< $(get_tmux_option "@neom-hg-show-diff-symbol" "!")
IFS=' ' read -r -a no_repo_message <<< $(get_tmux_option "@neom-hg-no-repo-message" "")
IFS=' ' read -r -a no_untracked_files <<< $(get_tmux_option "@neom-hg-no-untracked-files" "false")
