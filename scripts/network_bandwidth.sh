...
interface_get() {
  name="$(tmux show-option -gqv "@neom-network-bandwidth")"
...
main() {
  ...
  network_name=""
  show_interface="$(tmux show-option -gqv "@neom-network-bandwidth-show-interface")"
  interval_update="$(tmux show-option -gqv "@neom-network-bandwidth-interval")"
