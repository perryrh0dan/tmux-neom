...
# configuration
# @neom-continuum-mode default (countdown|time|alert|interval)
# @neom-continuum-time-threshold 15

alert_mode="@neom-continuum-mode"
time_threshold="@neom-continuum-time-threshold"
warn_threshold=360
first_save="@neom-continuum-first-save"
